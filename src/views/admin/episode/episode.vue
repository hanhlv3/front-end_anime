...
<template>
          ...
          <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
            <thead class="bg-gray-100 dark:bg-gray-700">
              <tr>
                ...
                <th scope="col" class="p-4 text-xs font-medium text-gray-500 uppercase dark:text-gray-400">Link</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
              ...
              >
                ...
                >
                  {{ episode.createdAt.substring(0, episode.createdAt.indexOf('T')) }}
                </td>
                <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                  {{
                    episode.updatedAt !== null
                      ? episode.updatedAt.substring(0, episode.updatedAt.indexOf('T'))
                      : 'Not update'
                  }}
                </td>
    ...
    <div class="flex items-center mb-4 sm:mb-0">
      ...
      <span class="text-sm font-normal text-gray-500 dark:text-gray-400"
        ...
        <span class="font-semibold text-gray-900 dark:text-white"
          ...
          {{ totalPage == currentPage ? episodes.length : currentPage * episodesPerPage }}</span
        >

        of
        <span class="font-semibold text-gray-900 dark:text-white">{{ episodes.length }}</span></span
      >
    </div>
  ...
  <!-- Add episode Drawer -->
  <add-episode v-if="isShowAdd" @close-add="isShowAdd = !isShowAdd" @add-episode="addEpisode" :filmId="filmId" />
  ...
  >
    <div class="flex">
      ...
      <div class="ml-3 text-sm font-normal">
        <span class="mb-1 text-sm font-semibold text-gray-900 dark:text-white">Notifiepisodeion</span>
...
export default {
  ...
  setup() {
    ...
    const totalPage = computed(() => Math.ceil(episodes.value.length / episodesPerPage.value))
